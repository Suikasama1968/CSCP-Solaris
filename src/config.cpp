...
//		#endif
	...
	config.solaris_audio_initial_chunks = MyGetPrivateProfileInt(_T("Solaris"), _T("AudioInitialChunks"), config.solaris_audio_initial_chunks, config_path);
	config.solaris_audio_max_refill_chunks = MyGetPrivateProfileInt(_T("Solaris"), _T("AudioMaxRefillChunks"), config.solaris_audio_max_refill_chunks, config_path);
	MyGetPrivateProfileString(_T("Solaris"), _T("InitialCMT"), config.solaris_initial_cmt, config.solaris_initial_cmt, _MAX_PATH, config_path);
	MyGetPrivateProfileString(_T("Solaris"), _T("InitialQD"), config.solaris_initial_qd, config.solaris_initial_qd, _MAX_PATH, config_path);
	#endif
	#ifdef _WIN32
		// for compatibilities
		#ifdef _X1_H_
...
//		#endif
	...
	MyWritePrivateProfileInt(_T("Solaris"), _T("AudioInitialChunks"), config.solaris_audio_initial_chunks, config_path);
	MyWritePrivateProfileInt(_T("Solaris"), _T("AudioMaxRefillChunks"), config.solaris_audio_max_refill_chunks, config_path);
	MyWritePrivateProfileString(_T("Solaris"), _T("InitialCMT"), config.solaris_initial_cmt, config_path);
	MyWritePrivateProfileString(_T("Solaris"), _T("InitialQD"), config.solaris_initial_qd, config_path);
	#endif
